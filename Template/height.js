...
( function() {
if ($(window).width() > 750) {
contentDiv = $("#wsdb_content");
contentMarginDiv = $("#wsdb_content_margin");
sidebar1Div = $("#wsdb_sidebar_left");
sidebar2Div = $("#wsdb_sidebar_right");
sidebar1MarginDiv = $("#wsdb_sidebar_left_margin");
sidebar2MarginDiv = $("#wsdb_sidebar_right_margin");
if (sidebar1Div != null)
{
